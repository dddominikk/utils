...
*/
const GhLoadInit0 = async function GhLoadInit(config) {
  this.GhEsModule = this.thisGhClass;
  await this.GhEsModule.configure(config);
  return this.GhEsModule.new;
};

const GhLoadInit = GhLoadInit0.bind({thisGhClass:GhEsModule})
